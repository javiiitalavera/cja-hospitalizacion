...
function parrafoBoldXml(label: string, valor: string | null | undefined, font = 'Calibri'): string {
...
export async function exportarInformeIngreso(ingreso: Ingreso, inf: InformeIngreso): Promise<void> {
  ...
  const cuerpo = [
    ...
    parrafoBoldXml('Alergias: ', inf.alergias, font),
    parrafoXml('', font),
    ...
    parrafoBoldXml('Sensorial: ', inf.vgi_sensorial, font),
    parrafoBoldXml('Nutricional: ', inf.vgi_nutricional, font),
    parrafoBoldXml('Dolor: ', inf.vgi_dolor, font),
    parrafoBoldXml('Otros síndromes geriátricos: ', inf.vgi_otros, font),
    parrafoXml('', font),
    seccionXml('ENFERMEDAD ACTUAL:', font),
    parrafoBoldXml('Personalidad previa: ', inf.personalidad_previa, font),
    ...
    parrafoBoldXml('Cognitivo: ', inf.situacion_cognitivo, font),
    parrafoBoldXml('Conductual: ', inf.situacion_conductual, font),
    parrafoBoldXml('Anímico: ', inf.situacion_animico, font),
    parrafoBoldXml('Funcional: ', inf.situacion_funcional, font),
    parrafoBoldXml('Social: ', inf.situacion_social, font),
    parrafoXml('', font),
...
export async function exportarInformeAlta(ingreso: Ingreso, ii: InformeIngreso, ia: InformeAlta): Promise<void> {
  ...
  const cuerpo = [
    ...
    parrafoXml('', font),
    seccionXml('ANTECEDENTES PATOLÓGICOS', font),
    parrafoBoldXml('Alergias: ', ii.alergias, font),
    parrafoXml('', font),
    parrafoBoldXml('Antecedentes médicos: ', '', font),
    ...
    parrafoBoldXml('Dolor: ', ii.vgi_dolor, font),
    parrafoBoldXml('Otros síndromes geriátricos: ', ii.vgi_otros, font),
    parrafoXml('', font),
    seccionXml('ENFERMEDAD ACTUAL:', font),
    parrafoBoldXml('Personalidad previa: ', ii.personalidad_previa, font),
    parrafoBoldXml('Evolución del deterioro cognitivo, conductual y funcional:', '', font),
    lineasXml(ii.evolucion, font),
    parrafoBoldXml('Situación actual:', '', font),
    parrafoBoldXml('Cognitivo: ', ii.situacion_cognitivo, font),
    parrafoBoldXml('Conductual: ', ii.situacion_conductual, font),
    parrafoBoldXml('Anímico: ', ii.situacion_animico, font),
    parrafoBoldXml('Funcional: ', ii.situacion_funcional, font),
    parrafoBoldXml('Social: ', ii.situacion_social, font),
    parrafoXml('', font),
    seccionXml('EXPLORACIÓN FÍSICA al ingreso:', font),
    ...
    parrafoXml('', font),
    seccionXml('EXPLORACIONES COMPLEMENTARIAS:', font),
    parrafoBoldXml('Al ingreso: ', ii.exploraciones_complementarias, font),
