...
export function Eventos() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-slate-800 mb-2">Eventos</h1>
      <p className="text-slate-400 text-sm">Usa la pestaña Eventos dentro de la ficha de cada paciente.</p>
    </div>
  )
}
