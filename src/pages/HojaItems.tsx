...
function PanelContencion({ ingresoId, esMedico, onCambio }: {
  ingresoId: string
  esMedico: boolean
  ...
  async function fetchPautas() {
    ...
    try {
      ...
      setPautas((data ?? []) as unknown as PautaContencion[])
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="py-1.5">
      {loading ? (
        ...
        <p className="text-xs text-slate-400 italic">Sin contenciones pautadas.</p>
      ) : (
